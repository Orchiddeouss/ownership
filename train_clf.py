    ...
    if args.black:
        if args.dataset == 'cifar10':
            ...
            if args.model_type == 'wrn28-10':
                args.v_g_f_path = './logits_set/vict-wrn28-10.pt/cifar10_seurat_10%/g_f.npy'
                args.i_g_f_path = './logits_set/benign-wrn28-10.pt/cifar10_seurat_10%/g_f.npy'
        elif args.dataset == 'imagenet':
            args.num_classes = 20
            if args.model_type == 'resnet34-imgnet':
                args.v_g_f_path = './logits_set/vict-imgnet-resnet34.pt/subimage_seurat_10%/g_f.npy'
                args.i_g_f_path = './logits_set/benign-imgnet-resnet34.pt/subimage_seurat_10%/g_f.npy'
        else:
